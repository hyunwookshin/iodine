...
function CommandApprovalBlock({ block, onApprove, onReject }: { block: UIBlock & { type: 'command-approval' }; onApprove: (remember: boolean) => void; onReject: () => void }) {
...
function MessageBubble({ msg, isLast, sendApproval, stopNarrationQueue, resolveApprovalNarration, onSuggestion, onVerbally, isSpeaking, isVerballyLoading, alwaysVerbally, onReverted, workspacePath, onNavigateToLine, shimmer }: { msg: UIMessage; isLast: boolean; sendApproval: (id: string, approved: boolean, remember?: boolean) => void; stopNarrationQueue: () => void; resolveApprovalNarration: (id: string, approved: boolean) => void; onSuggestion: (text: string) => void; onVerbally?: (text: string) => void; isSpeaking?: boolean; isVerballyLoading?: boolean; alwaysVerbally?: boolean; onReverted?: (path: string) => void; workspacePath: string | null; onNavigateToLine?: (filePath: string, line: number, endLine?: number, startCol?: number, endCol?: number) => void; shimmer?: boolean }) {
